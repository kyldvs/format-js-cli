...
function run(transformFile, paths, options) {
  ...
  getAllFiles(paths, function (name) {
    ...
    return fileChunks.map(function (files) {
      var child = child_process.fork(require.resolve('./Worker'), [transformFile, options.babel ? 'babel' : 'no-babel']);
    ...
    return _Promise.all(pendingWorkers).then(function (resolve) {
